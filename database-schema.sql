-- ISSO Scoreboard Database Schema
...
CREATE INDEX idx_football_goals_match_id ON football_goals(match_id);
CREATE INDEX idx_football_goals_team_id ON football_goals(team_id);
